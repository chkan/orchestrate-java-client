...
/**
 * Purge a KV object from a collection in the Orchestrate.io service. This will
 * permanently remove the record from the service, and cannot be undone.
 *
 * <p>Usage:
 * <pre>
 * {@code
 ...
 * if (result)
 *     System.out.println("Successfully purged 'someKey'.");
 * }
 * </pre>
 */
@ToString(callSuper=false)
@EqualsAndHashCode(callSuper=false)
public final class KvPurgeOperation extends AbstractOperation<Boolean> {
     ...
     */
    public KvPurgeOperation(final String collection, final String key) {
     ...
     */
    public KvPurgeOperation(final KvMetadata metadata) {
