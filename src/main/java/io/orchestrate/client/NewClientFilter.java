 ...
 */
@Slf4j
final class NewClientFilter extends BaseFilter {
    ...
    private static String buildBaseUserAgent() {
        ...
        try {
            ...
            String basePath = "/" + NewClientFilter.class.getPackage().getName().replace('.', '/');
            props.load(NewClientFilter.class.getResourceAsStream(basePath + "/build.properties"));
